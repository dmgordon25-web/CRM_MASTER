...
export async function init(ctx){
  ...
  if(__wired){
    log('[patch_2025-09-27_contact_linking_5C.init] already wired');
...
ensureCRM();
window.CRM.modules['patch_2025-09-27_contact_linking_5C'] = window.CRM.modules['patch_2025-09-27_contact_linking_5C'] || {};
window.CRM.modules['patch_2025-09-27_contact_linking_5C'].init = init;
