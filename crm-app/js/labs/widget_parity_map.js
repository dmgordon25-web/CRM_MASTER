...
export const DASH_TO_LABS_WIDGET_MAP = [
  ...
  { dashId: 'priorityActions', labsId: 'priorityActions', status: 'mapped', mountedVia: 'labs-native', dataSource: 'Open tasks with due dates (overdue and next 3 days)', countLogic: 'Urgent task rows rendered (max 6)', drilldown: 'Delegated click opens task editor', parity: '✅ parity' },
  { dashId: 'milestones', labsId: 'milestones', status: 'mapped', mountedVia: 'labs-native', note: 'Appointments feed', dataSource: 'Focus snapshot appointments', countLogic: 'Appointments deduped by contact+time (max 6)', drilldown: 'Delegated click opens contact editor', parity: '✅ parity' },

  // Partner & Referral widgets
  { dashId: 'leaderboard', labsId: 'referralLeaderboard', status: 'mapped', mountedVia: 'labs-native', dataSource: 'Partner referral stats', countLogic: 'Top partners by volume', drilldown: 'Delegated click opens partner editor', parity: '✅ parity' },
  ...
  { dashId: 'numbersReferrals', labsId: 'referralLeaderboard', status: 'mapped', mountedVia: 'labs-native', dataSource: 'Partner referral stats', countLogic: 'Top partners by volume', drilldown: 'Delegated click opens partner editor', parity: '✅ parity' },
