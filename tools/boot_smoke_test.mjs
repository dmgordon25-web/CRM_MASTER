  ...
  try {
    ...
    const actionCheck = await page.evaluate(() => new Promise((resolve) => {
      ...
      const onToast = (event) => {
        ...
        const msg = String((event && event.detail && event.detail.msg) || window.__LAST_TOAST__ || '');
      ...
      Promise.resolve().then(() => {
        ...
        if (tickNow > beforeTick || (tickNow === beforeTick && (window.__LAST_TOAST__ || '') !== beforeMsg)) {
          const msg = String(window.__LAST_TOAST__ || '');
        ...
        requestAnimationFrame(() => {
          ...
          if (tickLater > beforeTick || (tickLater === beforeTick && (window.__LAST_TOAST__ || '') !== beforeMsg)) {
            const msg = String(window.__LAST_TOAST__ || '');
