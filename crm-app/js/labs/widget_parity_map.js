...
export const DASH_TO_LABS_WIDGET_MAP = [
  ...
  { dashId: 'stale', labsId: 'staleDeals', status: 'experimental', note: 'Requires data polish; hidden by default' },
  ...
  { dashId: 'pipelineCalendar', labsId: 'pipelineCalendar', status: 'experimental', note: 'Timeline visuals still iterating' },
  { dashId: 'todo', labsId: 'todo', status: 'mapped' },
  { dashId: 'priorityActions', labsId: 'priorityActions', status: 'mapped' },
  { dashId: 'milestones', labsId: 'milestones', status: 'experimental', note: 'Appointment feed evolving' },
  { dashId: 'docPulse', labsId: 'docPulse', status: 'experimental', note: 'Milestone mapping incomplete' },
  ...
  { dashId: 'closingWatch', labsId: 'closingWatch', status: 'experimental', note: 'Prototype view available in experimental section' },
  { dashId: 'upcomingCelebrations', labsId: 'upcomingCelebrations', status: 'experimental', note: 'Data polish in progress' },
