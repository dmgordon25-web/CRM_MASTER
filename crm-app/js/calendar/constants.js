export const EVENT_CATEGORIES = Object.freeze([
    ...
    { key: 'email', label: 'Email', icon: '✉️', type: 'task', accent: '--accent-contact', tokens: ['email', 'mail'] },
    { key: 'sms', label: 'SMS', icon: '💬', type: 'task', accent: '--accent-partner', tokens: ['sms', 'text', 'message'] },
    ...
    { key: 'postal', label: 'Postal', icon: '📮', type: 'task', accent: '--accent-other', tokens: ['postal', 'mail', 'letter'] },
    { key: 'followup', label: 'Follow-up', icon: '🔔', type: 'task', accent: '--accent-milestone', tokens: ['follow-up', 'followup', 'follow', 'touch', 'reminder'] },
