...
export async function init(ctx){
  ...
  if(__wired){
    log('[patch_2025-10-02_medium_nice.init] already wired');
...
ensureCRM();
window.CRM.modules['patch_2025-10-02_medium_nice'] = window.CRM.modules['patch_2025-10-02_medium_nice'] || {};
window.CRM.modules['patch_2025-10-02_medium_nice'].init = init;
