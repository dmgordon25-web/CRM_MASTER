console.log('[DEBUG_LOAD] api.js loaded');
// import { openDB, dbPut } from '../db.js'; // Removed: db.js is global, no exports
...
export async function createMinimalTask(payload) {
  ...
  try {
    ...
    console && console.error && console.error('createMinimalTask dbPut failed', err);
