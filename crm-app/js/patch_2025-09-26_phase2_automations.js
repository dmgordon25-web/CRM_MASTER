...
export async function init(ctx){
  ...
  if(__wired){
    log('[patch_2025-09-26_phase2_automations.init] already wired');
...
ensureCRM();
window.CRM.modules['patch_2025-09-26_phase2_automations'] = window.CRM.modules['patch_2025-09-26_phase2_automations'] || {};
window.CRM.modules['patch_2025-09-26_phase2_automations'].init = init;
